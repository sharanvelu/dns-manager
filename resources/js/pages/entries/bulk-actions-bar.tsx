...
export function BulkActionsBar({ selectedIds, providers, onClear }: BulkActionsBarProps) {
    ...
    return (
        <div className="border-primary/20 bg-primary/5 flex flex-wrap items-center gap-2 rounded-xl border px-3 py-2">
            ...
            <div className="ml-auto flex flex-wrap items-center gap-2">
                ...
                <Button variant="outline" size="sm" className="h-8" onClick={() => setProvidersOpen(true)} disabled={busy}>
