...
/**
 * Cloudflare logo mark — the two-tone cloud in the official brand
 * oranges. Path data from Simple Icons (CC0), split into the two
 * cloud segments so each carries its official color. Cloudflare is
 * a trademark of Cloudflare, Inc., used here to identify the connector.
 */
