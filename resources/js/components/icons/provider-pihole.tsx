...
/**
 * Pi-hole logo mark — the official pi-with-leaf glyph. Path data from
 * Simple Icons (CC0). Rendered in the brand red (#96060C), lifted to a
 * brighter tint in dark mode for contrast. Pi-hole is a trademark of
 * Pi-hole LLC, used here to identify the connector.
 */
export function ProviderPiholeMark({ className, ...props }: SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            fill="currentColor"
            aria-hidden="true"
            className={cn('text-[#96060c] dark:text-[#d21d29]', className)}
            {...props}
        >
