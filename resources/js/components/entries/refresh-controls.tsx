...
interface RefreshControlsProps {
    /** Per-scope persistence — the global page keeps the historical key. */
    storageKey?: string;
}

export function RefreshControls({ storageKey = 'dns-manager:entries-auto-reload' }: RefreshControlsProps) {
